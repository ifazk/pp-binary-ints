...
val pp_int : Format.formatter -> nativeint -> unit
(** [pp_binary_int ~flags ~min_width fmt n] prints the integer [n] on the
    formatter [fmt]. *)

val make_pp_int : ?zero_padding:bool -> ?left_padding:bool -> ?separators:bool -> ?prefix:bool -> ?suffix:bool -> ?zero_special:bool -> ?min_width:int -> unit -> Format.formatter -> nativeint -> unit
...
val make_to_string : ?zero_padding:bool -> ?left_padding:bool -> ?separators:bool -> ?prefix:bool -> ?suffix:bool -> ?zero_special:bool -> ?min_width:int -> unit -> nativeint -> string
...
val pp_int_with : flags:Flags.flags -> min_width:int -> Format.formatter -> nativeint -> unit
...
val to_string_with : flags:Flags.flags -> min_width:int -> nativeint -> string
