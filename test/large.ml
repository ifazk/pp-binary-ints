...
let%test "zero inherit -1 64" [@tags "64-bits-only"] =
  ["0111111111111111111111111111111111111111111111111111111111111111"
  ;"0b111111111111111111111111111111111111111111111111111111111111111"
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width zero_inherit_configs 64 (-1)

let%test "left inherit -1 64" [@tags "64-bits-only"] =
  [" 111111111111111111111111111111111111111111111111111111111111111"
  ;"0b111111111111111111111111111111111111111111111111111111111111111"
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width left_inherit_configs 64 (-1)

let%test "right inherit -1 64" [@tags "64-bits-only"] =
  ["111111111111111111111111111111111111111111111111111111111111111 "
  ;"0b111111111111111111111111111111111111111111111111111111111111111"
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width right_inherit_configs 64 (-1)
...
let%test "zero inherit -1 65" [@tags "64-bits-only"] =
  ...
  test_width zero_inherit_configs 65 (-1)
...
let%test "left inherit -1 65" [@tags "64-bits-only"] =
  ...
  test_width left_inherit_configs 65 (-1)
...
let%test "right inherit -1 65" [@tags "64-bits-only"] =
  ...
  test_width right_inherit_configs 65 (-1)

let%test "zero inherit -1 78" [@tags "64-bits-only"] =
  ["000000000000000111111111111111111111111111111111111111111111111111111111111111"
  ;"0b0000000000000111111111111111111111111111111111111111111111111111111111111111"
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width zero_inherit_configs 78 (-1)

let%test "left inherit -1 78" [@tags "64-bits-only"] =
  ["               111111111111111111111111111111111111111111111111111111111111111"
  ;"             0b111111111111111111111111111111111111111111111111111111111111111"
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width left_inherit_configs 78 (-1)

let%test "right inherit -1 78" [@tags "64-bits-only"] =
  ["111111111111111111111111111111111111111111111111111111111111111               "
  ;"0b111111111111111111111111111111111111111111111111111111111111111             "
  ;"111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width right_inherit_configs 78 (-1)

let%test "zero inherit -1 79" [@tags "64-bits-only"] =
  ["0000000000000000111111111111111111111111111111111111111111111111111111111111111"
  ;"0b00000000000000111111111111111111111111111111111111111111111111111111111111111"
  ;"0111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ;"0b111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111"
  ] =
  test_width zero_inherit_configs 79 (-1)
...
let%test "left inherit -1 79" [@tags "64-bits-only"] =
  ...
  test_width left_inherit_configs 79 (-1)
...
let%test "right inherit -1 79" [@tags "64-bits-only"] =
  ...
  test_width right_inherit_configs 79 (-1)
...
let%test "zero inherit -1 80" [@tags "64-bits-only"] =
  ...
  test_width zero_inherit_configs 80 (-1)
...
let%test "left inherit -1 80" [@tags "64-bits-only"] =
  ...
  test_width left_inherit_configs 80 (-1)
...
let%test "right inherit -1 80" [@tags "64-bits-only"] =
  ...
  test_width right_inherit_configs 80 (-1)

let%test "zero inherit -1 81" [@tags "64-bits-only"] =
  ["000000000000000000111111111111111111111111111111111111111111111111111111111111111"
  ...
  test_width zero_inherit_configs 81 (-1)
...
let%test "left inherit -1 81" [@tags "64-bits-only"] =
  ...
  test_width left_inherit_configs 81 (-1)
...
let%test "right inherit -1 81" [@tags "64-bits-only"] =
  ...
  test_width right_inherit_configs 81 (-1)
