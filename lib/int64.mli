(** Module for pretty printing values of the type {!type:int64}. *)
...
val make_pp_int : ?zero_padding:bool -> ?left_padding:bool -> ?separators:bool -> ?prefix:bool -> ?suffix:bool -> ?zero_special:bool -> ?min_width:int -> unit -> Format.formatter -> int64 -> unit
...
val make_to_string : ?zero_padding:bool -> ?left_padding:bool -> ?separators:bool -> ?prefix:bool -> ?suffix:bool -> ?zero_special:bool -> ?min_width:int -> unit -> int64 -> string
...
val pp_int_with : flags:Flags.flags -> min_width:int -> Format.formatter -> int64 -> unit
