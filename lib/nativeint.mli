...
val pp_binary_int :
  flags:Flags.flags -> min_width:int -> Format.formatter -> nativeint -> unit
...
val make_pp_int :
  ?flags:Flags.flags -> ?min_width:int -> unit -> Format.formatter -> nativeint -> unit
...
val make_to_string :
  ?flags:Flags.flags -> ?min_width:int -> unit -> nativeint -> string
